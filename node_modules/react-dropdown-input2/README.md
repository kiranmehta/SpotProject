[![npm package](https://img.shields.io/npm/v/react-dropdown-input.svg?style=flat-square)](https://www.npmjs.org/package/react-dropdown-input2)
...
## Installation
    ...
    npm install react-dropdown-input2 --save
...
You can also pass `<DropdownInput>` all the properties that `<ReactBootstrap.FormControl>` allows,
eg. `ButtonAfter`.
...
* 0.1.12 Fork and React 14 compatibility